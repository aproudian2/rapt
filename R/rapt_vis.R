...
#'
#' \code{drawRNG} draws colored ranges from an RNG (as generated by
#' \code{\link{readRNG}}) on a plot of a
...
#'
#' \code{isoLabel} adds a set of lines and labels of isotopes generated by
#' \code{\link[enviPat]{isopattern}} to a \code{prettyPlot}. It currently
#' assumes (like prettyPlot) that the spectrum is log10 transformed. This will
#' be extended to arbitrary spectra in the future.
#'
#' @param ms A MassSpectrum. The (log transformed) mass spectrum to be marked.
...
#'   sequence of collors will be used.
